...
describe(".dispatchSeq", () => {
	...
	describe("wildcard", () => {
		it("should match with a wildcard in the front", async () => {
			...
			await dispatcher.dispatchSeq("*.created");
		...
		it("should match with a wildcard in the back", async () => {
			...
			await dispatcher.dispatchSeq("user.*");
		...
		it("should match with a wildcard in the middle", async () => {
			...
			await dispatcher.dispatchSeq("user.*.created", { pos: "middle" });
...
describe(".dispatchSync", () => {
	...
	describe("wildcard", () => {
		it("should match with a wildcard in the front", async () => {
			...
			dispatcher.dispatchSync("*.created");
		...
		it("should match with a wildcard in the middle", async () => {
			...
			dispatcher.dispatchSync("user.*.created", { pos: "middle" });
